...
| Status             | Description                          |
| ------------------ | ------------------------------------ |
| 🕐 **Pending**     | Tasks that are waiting to be started |
...
The application focuses on a clean and modern dashboard experience with:
...
* Easy-to-understand task status indicators
...
* Practice frontend development and React concepts
